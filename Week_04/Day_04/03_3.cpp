...
// This is only here to demonstrate possible effects of improper encapsulation.
// How it can spoil your program if You don't pay attention who can access
...
int main() {
	...
	// If You set this with the unsafe set method. It lingers in the memory.
